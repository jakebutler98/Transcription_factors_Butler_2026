#!/bin/bash --login
#$ -j y
#$ -o /mnt/jw01-aruk-home01/projects/oa_functional_genomics/projects/transcription_factors/analyses/PsA_TFs/logs/TOBIAS/FOOTPRINT/log_active_disease_CD8.txt
...
REGIONS=/mnt/jw01-aruk-home01/projects/oa_functional_genomics/projects/transcription_factors/analyses/PsA_TFs/data/clean/merged_PsA_macs2_peaks/all_CD8_ACTIVE_DISEASE.bed # Updated for active disease
